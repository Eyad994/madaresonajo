        ...
        <div class="row ">
            <div class='col-lg-12  '>
                <table class="table table-grid table-border table-md-6 mce-item-table">
                    ...
                    <tr>
                        <td>
                            <div class="cnt-box cnt-box-top-icon align-center" data-href="#"><i
                                        class="im-checked-user">&nbsp;</i>
                                <div class="caption"><h2>9000 clients</h2>
                                    <p>We are trusted by thousands of clients every year</p></div>
                            </div>
                        </td>
                        <td>
                            <div class="cnt-box cnt-box-top-icon align-center" data-href="#"><i
                                        class="im-paper-plane">&nbsp;</i>
                                <div class="caption"><h2>24/7 support</h2>
                                    <p>Premium support with 3h average response time</p></div>
                            </div>
                        </td>
                        <td>
                            <div class="cnt-box cnt-box-top-icon align-center" data-href="#"><i
                                        class="im-data-refresh">&nbsp;</i>
                                <div class="caption"><h2>Free updates</h2>
                                    <p>Enjoy free lifetime updates for all our products</p></div>
                            </div>
                        </td>
                        <td>
                            <div class="cnt-box cnt-box-top-icon align-center" data-href="#"><i
                                        class="im-film-strip ">&nbsp;</i>
                                <div class="caption"><h2>Images and PSDs</h2>
                                    <p>All demo images available plus Photoshop files</p></div>
                            </div>
                        </td>
                    </tr>
                    </tbody>
            ...
            <div class='col-lg-12  '>
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-6 align-right" data-anima="fade-right" data-time="1000"><img
                                class="margin-23" src="{{ asset('assets/images/intro/seoa6e5.png?1570696809946') }}" alt=""
