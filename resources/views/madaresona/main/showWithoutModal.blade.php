...
<link itemprop="thumbnailUrl" href="{{ env('IMAGE_URL') }}/images/{{ $school->name_en }}/{{ $school->school_logo }}">
<meta property="og:description"   content="{{app()->getLocale() == 'en' ? $school->name_en : $school->name_ar}}">
