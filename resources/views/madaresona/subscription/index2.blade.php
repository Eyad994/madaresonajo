...
@section('content')
                   ...
                   @if(Session::has('success'))
                    ...
                    <div class="col-md-4" style="bottom: 15px;">
                        <div class="col-md-12" style="text-align: center;margin-bottom: 40px ">
                            <img src="{{ asset('assets/images/supplier.jpg') }}" style="height: 200px; width: 200px;box-shadow: 1px 3px 5px 0px rgba(0, 0, 0, 0.75);
    border-radius: 10px;" alt="IMG">
                    ...
                    <div class="col-md-6">
                        <form class="contact100-form validate-form" action="{{ route('newSupplierSubscriptionsStore', app()->getLocale()) }}" method="POST">
                            @csrf
					<span class="contact100-form-title {{(app()->getLocale() == 'ar')?'text-right' :''}}" style="color:#1d556c;">
						{{__('index.suppliers_add')}}
					</span>
                            <h4 class="contact100-form-sub_title" >{{__('index.school_add_tex')}}</h4>
                            <div class="wrap-input100 validate-input" >
                                <input class="input100" type="text" name="name" placeholder="{{__('index.name')}}" value="{{ old('school_name') }}">
