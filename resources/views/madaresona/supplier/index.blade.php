                            ...
                            <article class="box">
                                <figure class="col-xs-3">
                                    <a title="Abu Moujeh Engineering and Construction" href="SuppliersDetails.aspx?opc_id=465 ">
                                        <img src="{{ env('IMAGE_URL') }}{{--https://dashboard.madaresonajo.com/images/Talayie Alhema Islamic Academy/1593673338.png--}}" style="height: 115px;width: 160px;">
                                    </a>
                                </figure>
                                <div class="details col-xs-9 clearfix">
                                    ...
                                    <div class="col-xs-6 col-sm-2 character">
                                        <dl class="" style="text-align: right;">
                                            ...
                                            <dd>عمان</dd>
                                            <dt class="skin-color">البريد الالكتروني</dt>
                                            <dd>asd@asd.com</dd>
                                        </dl>
                                    </div>
